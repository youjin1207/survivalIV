...
surv1.obs - surv0.obs ## true psi


### parametric estimation
result.if = binary_survival_para_if(dat = dat, time.list = time.list, misspecify = NULL, survival = "additive")

result.ipw = binary_survival_para_ipw(dat = dat, time.list = time.list, misspecify = NULL, survival = "additive")
